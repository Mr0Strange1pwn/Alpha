  ...
  return (
    <div className="milestone-header">
        ...
        <div style={{marginTop:"5%"}}>
          ...
          />
          <h4 style={{alignSelf:"center",paddingLeft:"10px"}}> Milestone</h4>
          </div>
              ...
              <div style={{ marginTop: "5%" }}>
                ...
                <div style={{ margin: "auto", width: "70%" }}>
                  <div className="row">
                    ...
                    <input
                      style={{border: showError  ? item.name.length === 0 ? " 1px solid red"  : null : null, }}
                      type="text"
                      id="fname"
                      name="name"
                      placeholder="Enter Name"
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      <select
                      style={{border: showError  ? item.status.length === 0 ? " 1px solid red"  : null : null, }}
                      class="form-select"
                      id="inputGroupSelect03"
                      aria-label="Example select with button addon"
                      name="status"
                  ...
                  <div className="row">
                    ...
                    <input
                      style={{border: showError  ? item.amount.length === 0 ? " 1px solid red"  : null : null, }}
                      type="text"
                      id="fname"
                      name="amount"
                      placeholder="Enter Amount"
