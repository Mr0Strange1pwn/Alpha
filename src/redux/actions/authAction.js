...
export const reset = (resData,token,routeChange) => {
  console.log("datassss", resData,token);
  ...
  return async (dispatch) => {
    await Axios.post("/Account/resetpassword", resData, HeaderToken()).then((res) => {
...
export const forgot = (useremail) => {
  ...
  console.log("useremail",forgetData)
  return async (dispatch) => {
    // await Axios.post(`forgotPassword?email=${useremail}`)
    await Axios.post("/Account/forgotPassword", forgetData)
    .then(
      (res) => {
        ...
        if (res.data.result === 'true') {
          toast.success("Reset password link sent to your email please check your mail");
...
export const logIn = (userInfo) => {
  ...
  return async (dispatch) => {
    await Axios.post("/Account/login", userInfo)
      .then((res) => {
        console.log("Login Ressss", res.data.data);
